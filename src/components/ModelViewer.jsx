...
const DesktopControls = ({ pivot, min, max, zoomEnabled, autoRotate, autoRotateSpeed }) => {
...
const ModelInner = ({
    ...
    return (
        <group ref={outer}>
            <group ref={inner}>
                <primitive object={content} rotation={modelRotation} />
            </group>
        </group>
    );
};
...
const ModelViewer = ({
    ...
    return (
        ...
        >
            ...
            <Canvas
                shadows
                frameloop="always" /* FORCE LOOP: Ensure animation plays */
